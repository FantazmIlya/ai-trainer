...
const wearableProviders = [
  ...
  },
  {
    ...
    mode: "FILE_EXPORT",
    summary: "Экспорт из Apple Health через CSV/JSON (или сторонний экспортер) и импорт в кабинет.",
    formats: ["csv", "json"],
  ...
  },
  {
    ...
    name: "Huawei Health",
    mode: "FILE_EXPORT",
    summary: "Экспорт тренировок из Huawei Health в CSV/GPX и загрузка через импорт файла.",
    formats: ["csv", "gpx"],
  ...
  },
  {
    ...
    mode: "FILE_EXPORT",
    summary: "Загрузка тренировок через экспорт CSV/GPX из Mi Fitness или совместимого сервиса.",
    formats: ["csv", "gpx"],
